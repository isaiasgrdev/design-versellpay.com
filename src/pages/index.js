        ...
        <div className="w-full flex flex-col justify-center items-center bg-black">
          ...
          <section className="flex mx-auto h-full w-full bg-black justify-center items-center">
              <div className="w-full max-w-[1100px] flex gap-5 justify-between items-center m-3 border-y border-[#54595f] p-8 max-[550px]:flex-col max-[550px]:justify-center">
                  <Container className={'max-[550px]:items-center'}>
                    <img className='max-w-[160px] w-full h-auto' src="https://versellpay.com/wp-content/uploads/2024/08/logo-versell.svg"/>
                    <span className="flex gap-5">
                        <ButtonLInk icon={faFacebook} link={'https://www.facebook.com/versellbank'}/>
                        <ButtonLInk icon={faInstagram} link={'https://www.instagram.com/versellpay/'}/>
                    </span>
                  </Container>
                  ...
                  <Container className={'max-[550px]:items-center'}>
                      ...
                      <p className="text-[#54595f] font-medium">contato@versellpay.com</p>
          ...
          <section className="flex mx-auto h-full w-full bg-black justify-center items-center">
              <div class="w-full max-w-[1100px] flex flex-col gap-3 justify-center items-center m-3 p-8">
                    <p className="text-[#54595f]">VERSELL 2024 © Todos os direitos reservados</p>
